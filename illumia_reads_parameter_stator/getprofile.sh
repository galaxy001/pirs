...
### Base-Calling distribution profile ###
# Using Soap2
...
./baseCalling_Matrix_calculator.pl -r ./ref/human.fa -l 91 -o BCpftestAsoap -b ./soap/testA.soap
...
./baseCalling_Matrix_calculator.pl -r ./ref/human.fa -l 91 -o BCpftestAbwa -b ./sam/testA.sam



### GC%-Depth distribution profile ###
# Using Soap2 result
